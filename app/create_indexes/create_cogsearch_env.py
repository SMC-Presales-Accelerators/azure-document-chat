...
AZURE_SEARCH_MANAGEMENT_KEY = os.environ['AZURE_SEARCH_KEY']
BLOB_CONNECTION_STRING = os.environ['BLOB_CHAT_CONNECTION_STRING']
BLOB_CONTAINER_NAME = os.environ['BLOB_CHAT_CONTAINER_NAME']
